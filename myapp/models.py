...
class Staff(DjangoCassandraModel):
	...
	sub=columns.Text(max_length=30)

class Contact(DjangoCassandraModel):
	id=columns.UUID(primary_key=True,default=uuid.uuid4)
	fname=columns.Text(max_length=20)
	lname=columns.Text(max_length=20)
	email=columns.Text(max_length=30) 
	phone=columns.Text(max_length=10)
	msg=columns.Text(max_length=500)
